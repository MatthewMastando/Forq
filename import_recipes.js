// Import Recipes Script for Forq App
// Run this script to import all existing recipes into Supabase
...
async function importRecipes() {
  try {
    ...
    console.log('\n✅ Recipe import completed successfully!');
