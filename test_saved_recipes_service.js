...
async function testSavedRecipesWithServiceRole() {
  try {
    console.log('🧪 Testing saved recipes with service role...');
    ...
    // 3. Check if we can insert a new saved recipe with service role
    console.log('\n3. Testing save recipe functionality with service role...');
...
testSavedRecipesWithServiceRole(); 