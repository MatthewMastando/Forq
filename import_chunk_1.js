// Import Chunk 1: Recipes 1-5
// Run this script to import the first 5 recipes into Supabase

import { createClient } from '@supabase/supabase-js';

// Your Supabase credentials
const supabaseUrl = 'https://wdvdhrxeoweosqjypojz.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndkdmRocnhlb3dlb3Nxanlwb2p6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM0MDQ4MDUsImV4cCI6MjA2ODk4MDgwNX0.2UnN7Enu8ek4V3ZfDTyE1XLfxXFkmJP-YfwVUcwCeS0';

const supabase = createClient(supabaseUrl, supabaseKey);

// User profiles for the first 5 recipes
const users = [
  {
  ...
  },
  {
    ...
    bio: 'Home baker and food enthusiast',
  ...
  },
  {
    ...
    bio: 'Plant-based cooking expert',
  ...
  },
  {
    ...
    bio: 'Pastry chef and dessert creator',
    avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150'
  }
];

// Recipes 1-5 from your app
const recipes = [
  {
...
async function importChunk1() {
  try {
    console.log('🚀 Starting Chunk 1 Import (Recipes 1-5)...');
    ...
    console.log(`📊 Imported ${recipes.length} recipes and ${users.length} users.`);
    console.log('\n📝 Next steps:');
